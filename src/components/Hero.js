      ...
      <div className="hero-container">
        ...
        <div className="links-wrap">
          <div className="links">
            <ul>
              <li>
                <a href="https://github.com/sahilkakwani9">
                  <svg
                    stroke="currentColor"
                    fill="#27aac8"
                    stroke-width="0"
                    viewBox="0 0 496 512"
                    class="h-16 w-16 sm:h-16 sm:w-16 fill-current"
                    height="4em"
                    width="4em"
              ...
              <li>
                <a href="https://twitter.com/somewhatsahil">
                  <svg
                    stroke="currentColor"
                    fill="#27aac8"
                    stroke-width="0"
              ...
              <li>
                <a href="https://www.linkedin.com/in/sahil-kakwani/">
                  <svg
                    stroke="currentColor"
                    fill="#27aac8"
                    stroke-width="0"
              ...
              <li>
                <a href="https://www.instagram.com/sahilkakwani9/">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="#27aac8"
                    width="4em"
